  ...
  <div style="max-width:900px;margin:auto;">
    ...
    <div class="card" style="max-width: 900px; margin: auto;">
      ...
      <div class="card-body">
        ...
        <input type="username" class="form-control w-auto" disabled value="@<?php echo $username; ?>">
        <br>
        <h5 class="card-title">Join Date</h5>
        <input type="text" class="form-control w-auto" disabled value="<?php echo userJoinDate($username); ?>">
        <br>
        <h5 class="card-title">Session ID</h5>
        <input type="text" class="form-control w-auto" disabled value="<?php echo $id; ?>">
        <br>
        <h5 class="card-title">Data</h5>
        <a href="api.php?username=<?php echo $username . "&password=" . read("data/db_users/@" . $username . "/" . $username . ".password") . "&action=list-all"; ?>"
          class="btn btn-primary">View all History</a>
        <br>
        <br>
