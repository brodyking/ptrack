  ...
  <div style="max-width:400px;margin:auto;">
    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        <p>Secure Session changes your Session ID on every pageload. This is more secure, but refreshing and bookmarks
        ...
        <div class="accordion" id="accordionExample">
          <div class="accordion-item" style="border: none;">
            ...
            <div id="collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
              <div class="accordion-body border mt-4 rounded">
                <code><pre style="margin: 0px;"><?php echo file_get_contents("data/db_users/".$username."/pouches.json"); ?></pre></code>
              </div>
            </div>
          </div>
          <br>
