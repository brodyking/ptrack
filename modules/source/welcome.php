<div class="container p-0 m-0 mb-4 text-center" style="min-width: 100%;">
  <h1 class="mb-3 fw-semibold lh-1 text-gradient"
    ...
    Welcome back, <span
      style="background: -webkit-linear-gradient(#98C2FD,#0D70FD);-webkit-background-clip: text;-webkit-text-fill-color: transparent;"><?php echo $username; ?></span>.
  </h1>
  <p class="text-center p-0 m-0" style="font-size:13pt;">You have used <span
    ...
    <span class="text-primary-emphasis"><?php echo pouchGetMgs($username, date("m-d-Y")); ?></span> total mgs today.</p>
</div>