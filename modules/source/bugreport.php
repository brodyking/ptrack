...
if (isset($_GET["success"])) {
  echo "<div class='alert alert-success'>Bug Report Submitted!</div>";
}
  ...
  <div class="card-body">
    <form method="POST" action="api.php?action=bugreport">
      ...
      <div class="mb-3">
        ...
        <input type="text" class="form-control" name="version" value="<?php echo getSiteVersion(); ?>" readonly>
      </div>
      <div class="mb-3">
      ...
      <div class="mb-3">
        ...
        <textarea class="form-control" name="bodytext" rows="3"></textarea>
      </div>
