...
<ul class="nav nav-tabs border-0 ps-2 pe-2 modepicker">
    <li class="nav-item" role="presentation">
        <button class="nav-link active" id="pouches-tab" onclick="alltabsPouches()" data-bs-toggle="tab"
    ...
    <li class="nav-item" role="presentation">
        <button class="nav-link" id="cans-tab" onclick="alltabsCans()" data-bs-toggle="tab" data-bs-target="#cans"
...
<div class="tab-content border p-2 rounded mode" id="myTabContent">
    <div class="tab-pane multi fade show active" id="pouches" role="tabpanel" aria-labelledby="pouches" tabindex="0">
        <?php
        include modulesGetPath("selection-pouches");
        include modulesGetPath("graph-pouches");
        ?>
    </div>
    <div class="tab-pane multi fade" id="cans" role="tabpanel" aria-labelledby="cans" tabindex="0">
        <?php
